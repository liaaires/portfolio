...
import svgPaths from "./svg-xk1xx3b6mn";
...
import { imgScreenChangeMe } from "./svg-x5gv1";
...
function BackgroundImageAndText({ text, additionalClassNames = "" }: BackgroundImageAndTextProps) {
  return (
    <div className={clsx("bg-[#aa4dff] content-stretch flex items-center justify-center px-[30px] py-[15px] relative rounded-[100px] shrink-0", additionalClassNames)}>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[16px] text-white">{text}</p>
    </div>
  );
}
...
export default function Home() {
  return (
    <div className="bg-white relative size-full" data-name="Home">
      <div className="-translate-x-1/2 absolute bg-[#190a46] h-[750px] left-1/2 top-0 w-[1440px]">
        <div className="absolute h-[750px] left-0 top-0 w-[1441px]">
          <div className="-translate-x-1/2 absolute h-[700px] left-[calc(50%-0.5px)] top-0 w-[1440px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 1440 700\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(4.4087e-15 35 -72 2.1431e-15 720 350)\\'><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'0.4375\\'/><stop stop-color=\\'rgba(238,223,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }} />
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[30px] items-center left-1/2 top-[calc(50%+19px)]">
          <div className="content-stretch flex flex-col items-center leading-[normal] not-italic relative shrink-0 text-[#0a0614]">
            <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[96px]">Lia Aires</p>
            <p className="font-['Inter:Extra_Light',sans-serif] font-extralight relative shrink-0 text-[30px] text-center w-[583px] whitespace-pre-wrap">Estudante e Designer UI/UX projetando experiências com intenção e pesquisa</p>
          </div>
          <div className="content-stretch flex gap-[30px] items-center justify-center relative shrink-0">
            ...
            <div className="h-[49px] relative shrink-0 w-[48px]">
              <div className="absolute bg-white h-[49px] left-0 rounded-[100px] top-[-0.5px] w-[48px]" data-name="ri:behance-fill">
                  ...
                  <div className="relative shrink-0 size-[24px]" data-name="ri:linkedin-fill">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                      <g id="ri:linkedin-fill">
                        <path d={svgPaths.p2c13d80} fill="var(--fill-0, #2349FF)" id="Vector" />
                      </g>
                    </svg>
                  </div>
                </div>
        ...
        <div className="-translate-x-1/2 absolute left-[calc(50%+0.5px)] top-[50px]">
      ...
      <div className="-translate-x-1/2 absolute bg-[#190a46] h-[750px] left-1/2 overflow-clip top-[750px] w-[1440px]">
        <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[16px] items-start justify-center left-[832px] top-[calc(50%-0.5px)]">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[50px] text-white w-[459px] whitespace-pre-wrap">Instituto Universidade Virtual</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[20px] text-white">UI/UX Design</p>
          <div className="bg-[#f26a2c] content-stretch flex h-[35px] items-center justify-center p-[15px] relative rounded-[20px] shrink-0 w-[143px]">
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[12px] text-white">Leia Mais</p>
          </div>
        </div>
        <CircleBackgroundImage additionalClassNames="left-[137px] top-[calc(50%+29px)]">
          <circle cx="293" cy="293" fill="var(--fill-0, #C27CFA)" id="Circle" r="293" />
        ...
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[132px] not-italic text-[40px] text-white top-[16px] w-[211px] whitespace-pre-wrap">Projetos</p>
      </div>
      <div className="absolute h-[656px] left-[128px] top-[2272px] w-[1137px]">
        <div className="-translate-x-1/2 absolute h-[523px] left-1/2 top-0 w-[1137px]">
          <div className="-translate-y-1/2 absolute h-[352px] left-0 top-[calc(50%+11.5px)] w-[619px]">
            <div className="absolute content-stretch flex flex-col items-start left-0 top-0">
              <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[70px] text-black">Obrigada!</p>
            </div>
            <div className="absolute content-stretch flex flex-col gap-[50px] items-start left-0 top-[127px] w-[1103px]">
              <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] min-w-full not-italic relative shrink-0 text-[30px] text-black w-[min-content] whitespace-pre-wrap">
                <span className="leading-[normal]">{`Sendo estudante de Sistemas e Mídias Digitais, `}</span>
                <span className="font-['Inter:Bold',sans-serif] font-bold leading-[normal]">projetar experiências baseadas em pesquisa que façam sentido para as pessoas</span>
      ...
      <div className="absolute h-[750px] left-[3px] top-[1500px] w-[1440px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 1440 750\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(4.4087e-15 37.5 -72 2.2962e-15 720 375)\\'><stop stop-color=\\'rgba(255,250,249,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(224,213,209,0.5)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }}>
        <div className="absolute bg-[rgba(255,255,255,0.3)] blur-[25px] h-[750px] left-0 top-0 w-[1440px]" />
        <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[16px] items-start leading-[normal] left-[128px] not-italic text-[#0a0614] top-1/2">
          <div className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[50px] whitespace-nowrap">
            <p className="mb-0">Catálogo Radiant</p>
            <p>Patterns</p>
          </div>
          <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[20px]">UI Design</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[20px]">{`Página em construção `}</p>
        </div>
        <CircleBackgroundImage additionalClassNames="left-[687px] top-[calc(50%+37px)]">
          <circle cx="293" cy="293" fill="var(--fill-0, #FEDE64)" id="Circle" r="293" />
        </CircleBackgroundImage>
